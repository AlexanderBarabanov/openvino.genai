...
const ChevronLeftIcon: React.FC<{ size?: number }> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
    <polyline points="15,18 9,12 15,6"></polyline>
  </svg>
);

const ChevronRightIcon: React.FC<{ size?: number }> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
...
const Carousel: React.FC<CarouselProps> = ({
  ...
  }, [currentSlide, autoSlideTimeout, enableAutoSlide, isPaused, totalSlides, slidesToShow, maxSlideIndex]);
